...
/** @type {string} */
const CACHE_VERSION = '1750752062|682554672';
/** @type {string} */
const CACHE_PREFIX = 'First Gameing-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'First Gameing.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["First Gameing.html","First Gameing.js","First Gameing.offline.html","First Gameing.icon.png","First Gameing.apple-touch-icon.png","First Gameing.audio.worklet.js","First Gameing.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["First Gameing.wasm","First Gameing.pck"];
